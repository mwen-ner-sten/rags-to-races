...
export const LOCATION_DEFINITIONS: LocationDefinition[] = [
  {
    ...
    unlockCost: 0,
    scavengeTime: 2000,
    partDropRates: { engine: 1, wheel: 2, frame: 1, electronics: 0.5, fuel: 1, misc: 4 },
    rarityBias: 0.1,
  ...
  },
  {
    ...
    unlockCost: 5,
    scavengeTime: 3000,
    partDropRates: { engine: 2, wheel: 2, frame: 2, electronics: 1, fuel: 2, misc: 2 },
    rarityBias: 0.2,
    maxPartsPerScavenge: 2,
  },
  {
    ...
    unlockCost: 20,
    scavengeTime: 4000,
    partDropRates: { engine: 3, wheel: 3, frame: 4, electronics: 2, fuel: 2, misc: 1 },
    rarityBias: 0.35,
  ...
  },
  {
    ...
    unlockCost: 60,
    scavengeTime: 5000,
    partDropRates: { engine: 4, wheel: 2, frame: 3, electronics: 3, fuel: 2, misc: 1 },
    rarityBias: 0.5,
    maxPartsPerScavenge: 3,
  },
  {
    ...
    unlockCost: 150,
    scavengeTime: 6000,
    partDropRates: { engine: 4, wheel: 3, frame: 3, electronics: 5, fuel: 3, misc: 0 },
    rarityBias: 0.65,
  ...
  },
  {
    ...
    unlockCost: 400,
    scavengeTime: 8000,
    partDropRates: { engine: 5, wheel: 2, frame: 4, electronics: 5, fuel: 2, misc: 0 },
    rarityBias: 0.8,
    maxPartsPerScavenge: 4,
  },
];
