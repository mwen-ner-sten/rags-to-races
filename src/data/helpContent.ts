...
export const HELP_TUTORIAL_WALKTHROUGH: { step: string; description: string }[] = [
  ...
  { step: "Check odds", description: "Review your win chance and DNF risk. DNF stands for Did Not Finish; in this game, it usually means your vehicle broke down before the finish." },
...
export const HELP_GLOSSARY: { term: string; meaning: string }[] = [
  ...
  { term: "DNF (Did Not Finish)", meaning: "You did not complete the race, usually because your vehicle broke down before the finish. Baseline chance is 30% minus reliability/200, then equipment, crew, skills, philosophy, and the race plan modify it." },
  ...
  { term: "Achievement", meaning: "Lifetime milestone that grants permanent bonuses. Tracked across all resets. View in Upgrades > Achievements." },
