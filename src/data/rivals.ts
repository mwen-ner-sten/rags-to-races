...
export const RIVAL_DEFINITIONS: RivalDefinition[] = [
  { id: "rival_greasy_pete", name: "Greasy Pete", flavor: "A junkyard mechanic who wins with ugly, unbreakable machines.", minCircuitTier: 1, maxCircuitTier: 2, reward: { type: "addon", id: "addon_roll_cage", label: "Greasy Pete's Roll Cage add-on" } },
...
export function formatRivalWinStatus(rival: RivalDefinition, rewardClaimed: boolean): string {
  return rewardClaimed
    ? `Defeated · ${rival.reward.label}`
    : "Rematch won · reward already claimed";
}
