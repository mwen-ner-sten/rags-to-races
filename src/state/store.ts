...
export interface GameState {
  ...
  prestige: () => void;
  applyTickResult: (partsFound: ScavengedPart[], scrapsEarned: number, repEarned: number, vehicleWear?: number, vehicleRepair?: number, lootGearDrops?: LootGearItem[], modDrops?: InstalledMod[]) => void;
...
function createActions(set: any, get: any) {
  return {
    ...
    applyTickResult: (partsFound: ScavengedPart[], scrapsEarned: number, repEarned: number, vehicleWear?: number, vehicleRepair?: number, lootGearDrops?: LootGearItem[], modDrops?: InstalledMod[]) => {
      set((s: GameState) => {
